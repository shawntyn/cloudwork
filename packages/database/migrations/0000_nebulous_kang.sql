CREATE TYPE "public"."runtime_status" AS ENUM('STARTING', 'RUNNING', 'IDLE', 'STOPPED', 'REMOVED', 'ERROR');--> statement-breakpoint
...
CREATE TABLE "agent_sessions" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "agent_sessions_dsh_session_id_unique" UNIQUE("dsh_session_id")
);
--> statement-breakpoint
CREATE TABLE "runtime_instances" (
	...
	"status" "runtime_status" DEFAULT 'REMOVED' NOT NULL,
	"host_id" text DEFAULT 'local' NOT NULL,
	"last_active_at" timestamp with time zone DEFAULT now() NOT NULL,
	"stopped_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "runtime_instances_user_id_unique" UNIQUE("user_id"),
	CONSTRAINT "runtime_instances_container_name_unique" UNIQUE("container_name")
);
--> statement-breakpoint
...
ALTER TABLE "runtime_instances" ADD CONSTRAINT "runtime_instances_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "runtime_reaper_idx" ON "runtime_instances" USING btree ("status","last_active_at");--> statement-breakpoint
